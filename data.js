;document.addEventListener('DOMContentLoaded', function(){
	...
	FIRST_PLACE = 5; SECOND_PLACE = 4; THIRD_PLACE = 3; PARTICIPANT = 1; NOT_PARTICIPANT = 0;
	...
	//calculate rating
	data.games.forEach(game => game.results.forEach(result => data.players.find(player => player.id == result.player).rating += result.score));
